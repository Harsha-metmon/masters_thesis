...
def do_control(q,waypoints,p_err):
...
[x, y, theta] = np.array([0.9, 0.9, 0.1])

[points,Vx_i,Vy_i,omega_i,diff_t]=gui_rock()
...
p = multiprocessing.Process(target=do_control, args=(q,waypoints,p_err))
ctx = zmq.Context()
